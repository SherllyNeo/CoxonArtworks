...
function About() {
    ...
    <img 
      ...
      style={{ height: "100%",width: "100%", maxWidth: "500px",   display: "block", marginLeft: "auto", marginRight: "auto" }} 
    />
    </div>
        <div class="column">
...
<p>            The artworks of Coxon are a varied collection of works that she has developed over the course of her time in the art industry. </p>
<p>            The city of Leicester is where Elizabeth is now residing, and she is working towards earning a bachelor's degree in fine art. </p>
<p>            She takes an active role in the study and curation of her work, which is continually influenced by the natural world and the human body. </p>
